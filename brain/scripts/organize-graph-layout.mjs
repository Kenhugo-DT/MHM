...
const ZONE_TERMS = {
  ...
  "country-roots": [
    "bluegrass", "carter family", "chet atkins", "country", "country rock",
    "hank williams", "honky tonk", "jerry reed", "jimmie rodgers",
    "johnny cash", "merle haggard", "patsy cline", "western swing",
    "willie nelson", "bill monroe",
  ],
  jazz: [
    "bebop", "charlie parker", "django reinhardt", "duke ellington",
    "joe pass", "john coltrane", "john mclaughlin", "jazz",
    "jazz fusion", "louis armstrong", "miles davis", "swing",
    "wes montgomery",
  ],
  "punk-alt": [
    "afi",
